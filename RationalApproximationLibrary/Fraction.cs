...
namespace RationalApproximationLibrary
{
    ...
    public class Fraction : IEquatable<Fraction>, IComparable<Fraction>
    {
        ...
        // from WolframAlpha:
        const string PiString = "3.";
        ...
        const string EulerNumberString = "2.";
